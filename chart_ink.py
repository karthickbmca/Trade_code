...
df = pd.read_excel(r'C:\Users\Karthick\Downloads\emas_1, Technical Analysis Scanner (4).xlsx')[1:]
...
pathlib.Path(r"D:\Trade\smart_list\smart_list_" + end.strftime('%d%m%Y') +".txt").write_text(smart_shares_top_prior)
