...
df = pd.read_excel(r'C:\Users\User\Downloads\emas_1, Technical Analysis Scanner (3).xlsx')[1:]
...
get_sector = df.merge(data_eq,left_on=(['Unnamed: 2']),right_on=(['Security Id']),how='left')[['Security Id','ISubgroup Name']]
